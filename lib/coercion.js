 ...
 * @method `boolCoercion` - Coerce boolean type SillyTavern strings into a bool datatype.
 * @method `boolParse` - Coerce boolean type SillyTavern strings into a strict bool datatype.
 * @method `numCoercion` - Coerce any SillyTavern string value into a number datatype.
 * @method `floatParse` - Coerce floatpoint type SillyTavern strings into a number datatype.
 * @method `intParse` - Coerce integer type SillyTavern strings into a number datatype.
 * @method `jsonParse` - Coerce any SillyTavern string value into an object or array datatype.
 * @method `valueparse` - Coerce any SillyTavern string into the appropriate datatype.
 */
 ...
 * @method `resolveLocalVarToValue` - Resolves a local variable shorthand to it's associated variable's parsed value.
 ...
 * @method `resolveLocalVarToStrictBool` - Resolves a local variable shorthand to it's associated variable's parsed strict boolean value.
 * @method `resolveLocalVarToFloat` - Resolves a local variable shorthand to it's associated variable's parsed floatpoint value.
 * @method `resolveLocalVarToInt` - Resolves a local variable shorthand to it's associated variable's parsed integer value.
 * @method `resolveLocalVarToJSON` - Resolves a local variable shorthand to it's associated variable's parsed JSON value.
 * @method `resolveLocalVarToYAML` - Resolves a local variable shorthand to it's associated variable's parsed YAML value.
 * @method `resolveLocalVarToMutableJSON` - Resolves a local variable shorthand to it's associated variable's parsed JSON value and makes it mutable.
 * @method `resolveLocalVarToMutableYAML` - Resolves a local variable shorthand to it's associated variable's parsed YAML value and makes it mutable.
 *
 * ===**Global Variables**===
 * @method `resolveGlobalVar` - Resolves a global variable shorthand to it's associated variable's value.
 * @method `resolveGlobalVarToValue` - Resolves a global variable shorthand to it's associated variable's parsed value.
 ...
 * @method `resolveGlobalVarToStrictBool` - Resolves a global variable shorthand to it's associated variable's parsed strict boolean value.
 * @method `resolveGlobalVarToFloat` - Resolves a global variable shorthand to it's associated variable's parsed floatpoint value.
 * @method `resolveGlobalVarToInt` - Resolves a global variable shorthand to it's associated variable's parsed integer value.
 * @method `resolveGlobalVarToJSON` - Resolves a global variable shorthand to it's associated variable's parsed JSON value.
 * @method `resolveGlobalVarToYAML` - Resolves a global variable shorthand to it's associated variable's parsed
 * @method `resolveGlobalVarToMutableJSON` - Resolves a global variable shorthand to it's associated variable's parsed JSON value and makes it mutable.
 * @method `resolveGlobalVarToMutableYAML` - Resolves a global variable shorthand to it's associated variable's parsed YAML value and makes it mutable.
 */
const SharedResolvers = (() => {
    ...
    return {
        ...
        resolveLocalVarToNum(varName) {
            ...
            if (value !== '') {
                return SharedValueCoercion.numCoercion(value);
            } else {
                throw new Error('[Nox-Lib] No such variable: ' + varName + '(Local)');
            }
        },
 ...
 * @method `shorthandNumResolver` - Resolves a variable shorthand to it's associated variable's coerced numeric value.
...
const VarShorthand = (() => {
    ...
    function resolveScopeVarToNum(varName, args) {
        if (args._scope.existsVariable(varName)) {
            return SharedValueCoercion.numCoercion(args._scope.getVariable(varName));
        } else {
            throw new Error('[Nox-Lib] No such variable: ' + varName + '(Scope)');
        }
    }
    ...
    return {
        ...
        shorthandLaxNumResolver(target, args) {
            ...
            if (!prefix || !varName) {
                return SharedValueCoercion.numCoercion(target);
            }
